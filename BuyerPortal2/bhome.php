...
<body>
    ...
    <nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse left ">
            ...
            <a class="float-left" href="bhome.php">
                <img src="agros.png" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
            </a>
        </div>
        ...
        <a class="float-left" href="bhome.php">
            <img src="agros.png" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
        </a>
    ...
    <div class="container"> <img src="welcome.jpeg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
